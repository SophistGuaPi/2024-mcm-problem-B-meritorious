...
V=14.8;
position=[5000 3000 300;10 20 40];
velocity=[2 -3 3;0 0 0];
mass=6.519e3+8.629e3;
I=[15.451e3 6.712e3 15.923e3];
delta_t=1;
num=1000;
s(num)=Submarine;

mass_amp=linspace(-500,500,num);
% velocity_amp=linspace(-20,20,num);
velocity_amp=1;
l_amp=20;h_amp=10;ang_amp=10;
for i=1:num
    s(i).V=V;s(i).I=I;s(i).delta_t=delta_t;
    s(i).mass=mass+mass_amp(i);
    ...
    s(i).velocity(1,:)=velocity(1,:)+velocity_amp.*randn([1,3]);%velocity_amp(i);
